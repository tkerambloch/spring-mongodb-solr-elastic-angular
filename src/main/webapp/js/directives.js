...
var directivesTestApp = angular.module('testApp.directives', []);

directivesTestApp.directive('ttlInput', function() {
    return {
        templateUrl: 'partials/template/ttl-input.html',
        restrict: 'E',
        scope: {
            model: '='
        },
...
directivesTestApp.directive('passwordStrengthBar', function() {
    return {
        replace: true,
        restrict: 'E',
...
directivesTestApp.directive('formAutoFillFix', function() {
...
directivesTestApp.directive('passwordMatch', [function () {
    return {
        restrict: 'A',
        scope:true,
        require: 'ngModel',
...
directivesTestApp.directive('validateEmailTemplate', function() {
    return {
        restrict: 'A',
        require: 'ngModel',
        scope: {
...
directivesTestApp.directive("tokenPopover", function($popover) {
    return {
        restrict: "A",
        scope: {tokenPopover: '='},
...
directivesTestApp.directive("ngScopeElement", function () {
...
directivesTestApp.directive('bootstrapTagsinputObject', ['$compile', function($compile) {
...
directivesTestApp.directive('bootstrapTagsinput', ['$compile', function($compile) {
...
directivesTestApp.directive('validateTemplate', function() {
    return {
        restrict: 'A',
        link: function(scope, element, attrs, ctrl) {
...
directivesTestApp.directive('numbersOnly', function() {
    return {
        require: 'ngModel',
...
directivesTestApp.directive('resize', function ($window) {
...
directivesTestApp.directive('filteredTable', function($filter) {
    return {
        restrict : 'E',
        templateUrl : 'partials/template/filtered-table.html',
        scope : {
            headers : '=',
            filterCriteria : '=',
            model : '=',
...
directivesTestApp.directive('sortBy', function () {
    return {
        templateUrl: 'partials/template/sort-by.html',
        restrict: 'E',
        transclude: true,
        replace: true,
        scope: {
...
directivesTestApp.directive('onBlurChange', function ($parse) {
...
directivesTestApp.directive('onEnterBlur', function() {
